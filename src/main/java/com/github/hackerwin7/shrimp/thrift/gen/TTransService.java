...
public class TTransService {
  ...
  public interface Iface {
     ...
     * @param pool
     */
    public void sendPool(TFilePool pool) throws org.apache.thrift.TException;
     ...
     * @param info
     */
    public void addFile(TFileInfo info) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void sendPool(TFilePool pool, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void addFile(TFileInfo info, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_sendPool(TFilePool pool) throws org.apache.thrift.TException
    {
      sendPool_args args = new sendPool_args();
      args.setPool(pool);
      sendBaseOneway("sendPool", args);
    }
    ...
    public void send_addFile(TFileInfo info) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void sendPool(TFilePool pool, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      sendPool_call method_call = new sendPool_call(pool, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class sendPool_call extends org.apache.thrift.async.TAsyncMethodCall {
      private TFilePool pool;
      public sendPool_call(TFilePool pool, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, true);
        this.pool = pool;
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("sendPool", org.apache.thrift.protocol.TMessageType.ONEWAY, 0));
        sendPool_args args = new sendPool_args();
        args.setPool(pool);
        args.write(prot);
        prot.writeMessageEnd();
    ...
    public void addFile(TFileInfo info, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      addFile_call method_call = new addFile_call(info, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class addFile_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public addFile_call(TFileInfo info, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, true);
        this.info = info;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("sendPool", new sendPool());
    ...
    public static class sendPool<I extends Iface> extends org.apache.thrift.ProcessFunction<I, sendPool_args> {
      public sendPool() {
        super("sendPool");
      }

      public sendPool_args getEmptyArgsInstance() {
        return new sendPool_args();
      }
      ...
      public org.apache.thrift.TBase getResult(I iface, sendPool_args args) throws org.apache.thrift.TException {
        iface.sendPool(args.pool);
        return null;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class sendPool<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sendPool_args, Void> {
      public sendPool() {
        super("sendPool");
      }
      ...
      public void start(I iface, sendPool_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.sendPool(args.pool,resultHandler);
      }
    }
    ...
    public static class addFile<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, addFile_args, Void> {
      ...
      public void start(I iface, addFile_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.addFile(args.info,resultHandler);
      }
    }
  ...
  public static class sendPool_args implements org.apache.thrift.TBase<sendPool_args, sendPool_args._Fields>, java.io.Serializable, Cloneable, Comparable<sendPool_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("sendPool_args");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new sendPool_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new sendPool_argsTupleSchemeFactory());
    }
    ...
    static {
      ...
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(sendPool_args.class, metaDataMap);
    }

    public sendPool_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public sendPool_args(sendPool_args other) {
      if (other.isSetPool()) {
        this.pool = new TFilePool(other.pool);
      }
    }

    public sendPool_args deepCopy() {
      return new sendPool_args(this);
    }
    ...
    public sendPool_args setPool(TFilePool pool) {
      this.pool = pool;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof sendPool_args)
        return this.equals((sendPool_args)that);
      return false;
    }

    public boolean equals(sendPool_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(sendPool_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("sendPool_args(");
      boolean first = true;
    ...
    private static class sendPool_argsStandardSchemeFactory implements SchemeFactory {
      public sendPool_argsStandardScheme getScheme() {
        return new sendPool_argsStandardScheme();
      }
    }

    private static class sendPool_argsStandardScheme extends StandardScheme<sendPool_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, sendPool_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sendPool_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class sendPool_argsTupleSchemeFactory implements SchemeFactory {
      public sendPool_argsTupleScheme getScheme() {
        return new sendPool_argsTupleScheme();
      }
    }

    private static class sendPool_argsTupleScheme extends TupleScheme<sendPool_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, sendPool_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetPool()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, sendPool_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.pool = new TFilePool();
